...
// Initializes state with RIPEMD-160 constants
void Initialize(__m512i state[5]);

// Processes 16 message blocks in parallel
void Transform(__m512i state[5], uint8_t *blocks[16]);

// Computes RIPEMD-160 hash for 16 32-byte messages
